...
public static class GameStat
{
    ...
    public enum WorldName {None, WildWorld, ForgeWorld, HighBorn, HiveWorld, TempleWorld, VoidBorn, 
    AgroWorld, FeodalWorld, FrontWorld, DemonWorld, PrisonWorld, QuarantineWorld, DeadWorld, GardenWorld,
    ScienseStation, }
