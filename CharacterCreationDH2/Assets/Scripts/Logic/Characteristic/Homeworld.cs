...
public class Homeworld 
{
    ...
    public Homeworld(string name, GameStat.CharacterName firstAdvantage, GameStat.CharacterName secondAdvantage, GameStat.CharacterName disadvantageCharacteristic, int fatepoint, 
        GameStat.Inclinations inclination, int wound)
    {
        this.name = name;
