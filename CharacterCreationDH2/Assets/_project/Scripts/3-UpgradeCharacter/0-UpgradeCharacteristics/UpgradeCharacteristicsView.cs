...
namespace CharacterCreation
{
    public class UpgradeCharacteristicsView : AnimateShowAndHideView
    {
        ...
        [SerializeField]
        TextMeshProUGUI _textAmountWeapon, _textAmountBallistic, _textAmountStrength, _textAmountToughness,
        ...
        [SerializeField]
        List<Image> _listImagesWeapon, _listImagesBallistic, _listImagesStrength, _listImagesToughness,
